...
const Match: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchMatch = async () => {
      // First get the user's row id from the users table
      ...
      // Query matches where user is either user_a or user_b, latest first
      ...
      <AppShell showNav>
        <div className="p-8 pt-16 flex flex-col items-center text-center min-h-[80vh] justify-center">
          ...
          <p className="text-muted-foreground text-sm max-w-[280px] mb-8">
            每周三晚 8 点会收到新的匹配。确保你已开启「参加匹配」开关。
          </p>
      ...
      <div className="p-6 pt-12">
        <div className="text-center mb-8">
          ...
          <div className="flex items-baseline justify-center gap-1 mt-4">
            <h2 className="font-serif text-6xl font-bold text-primary">
